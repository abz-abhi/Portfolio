const  CurrentlyWork = () => {
  return (
    <div class="italic w-fit  md:ml-96 md:mt-11 md:p-0 xxs:p-5 xxs:-mt-10 xs:mt-10">
      ...
      <p class="md:text-2xl xxs:text-[12px] xs:text-[15px] flex items-center whitespace-nowrap md:mt-0 xxs:-mt-3 leading-tight">
      ...
      <p class="md:text-2xl md:mt-12 xxs:mt-6 xxs:text-[12px] xs:text-[15px]">
